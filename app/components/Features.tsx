    ...
    <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px]">
        <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
            ...
            <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
                ...
                <h1 className="pt-[12px] text-2xl font-medium text-[#172026] lg:text-[42px] lg:leading-[58px]">Simplify
                    your sales monitoring</h1>

                <Image src={Feature1} alt="" className="pt-[24px] sm:hidden" />
                <p className="py-[24px] text-[#36485C] lg:text-[18px]">Stay on top of things and revamp your work process with our
                    game-changing feature. Get a bird&apos;s eye
                    view with our customizable dashboard. </p>
                ...
                <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#0085FF] lg:text-[18px]"> Learn More <span>
                        <Image src={BlueButton} alt="" /></span> </p>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-x-6 sm:flex-row">
            ...
            <div className="sm:w-1/2 lg:py-[56px] lg:pl-[56px]">
                ...
                <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#00A424] lg:text-[18px]"> Learn More <span>
                        <Image src={GreenButton} alt="" /></span> </p>
            </div>
        </div>
            ...
            <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
                ...
                <div className="flex w-full gap-x-[24px]">
                    ...
                    <div className="w-1/2 flex flex-col gap-y-3">
                        ...
                        <p className="text-[#36485C]">Trying my best here</p>
                    </div>
                </div>

                <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#EB2891] lg:text-[18px]"> Learn More <span>
                        <Image src={PinkButton} alt="" /></span> </p>
            </div>
        </div>
    </div>
)
