...
const items = [
{
    ...
    answer: `Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore. Nemo enim
    ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit. Lorem ipsum dolor sit amet, consectetur adipiscing
    elit. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.`
},
{
    question: `Ut enim ad minima veniam, quis nostrum exercitationem ullam?`,
    answer: `Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore. Nemo enim
...
<div className="flex flex-col w-full py-[48px] lg:py-[60px] lg:flex-row lg:gap-x-6">
    <div className="lg:w-1/3 lg:py-8 lg:pr-14">
        ...
        <p className="text-[#36495C] pb-[24px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
              ...
              <div key={index}>
                    <Accordion.Item value={`item-${index + 1}`} className="bg-[#E3F1FF] p-[16px] rounded-[8px]">
                        <Accordion.Header>
                            ...
                            <span>
                                <Image src={Plus} alt="" className="h-10 w-10 lg:h-5 lg:w-5" />
                            </span>
                            </Accordion.Trigger>
                        </Accordion.Header>
