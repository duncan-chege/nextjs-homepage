...
<div className="py-[48px] lg:py-[60px]">
    <p className="text-[#172026] text-center text-2xl font-medium lg:text-[42px]">Flexible plans for you</p>
    ...
    <div className="flex flex-col gap-y-6 gap-x-[24px] lg:flex-row">
        <div className="w-full rounded[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
            <div>
                ...
                <h2 className="pt-4 text-2xl font-medium lg:text-[32px]">0$<span className="text-[#5F7896]">/mo</span>
                </h2>
            ...
            <button className="mt-[16px] rounded-[4px] bg-white py-[14px] text-[#4328EB] font-medium">Start
                Trial</button>
        </div>
        ...
        <div className="w-full rounded[8px] bg-[#4328EB] p-6 flex flex-col">
            <div>
                ...
                <h2 className="pt-4 text-2xl text-white font-medium lg:text-[32px]">$500<span
                        className="text-[#F4F8FA]">/mo</span></h2>

                <ul className="flex flex-col gap-y-2 pt-4 text-[#F4F8FA]">
                    <li className="flex items-center gap-x-2">
                        <span>
                            <Image src={WhiteCheck} alt="" />
                        </span>
                        Lorem ipsum dolor sit amet
                    </li>
                    <li className="flex items-center gap-x-2">
            ...
            <button className="mt-[16px] rounded-[4px] bg-white py-[14px] text-[#4328EB] font-medium">Get
                Started</button>
        </div>
        ...
        <div className="w-full rounded[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
            <div>
                ...
                <p className="pt-2 text-[16px] text-[#36485C]">
                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit. Lorem ipsum dolor sit
